...
if __name__ == "__main__":
    ...
    ori_img = cv2.imread('Data\data_20.jpeg')
    ...
    if (6 in class_ids):
        Not_good = 1
        cv2.putText(img, 'Status: Not good', (Blank.shape[0]//8, Blank.shape[1]//8), cv2.FONT_HERSHEY_SIMPLEX, fontScale = 1, color = (255,0,0), thickness = 2)
        ...
        for i in range (len(boxes)):
            if (class_ids == [2,3]):
                ...
                Not_good = 1
                cv2.putText(img, 'Status: Not good', (Blank.shape[0]//8, Blank.shape[1]//8), cv2.FONT_HERSHEY_SIMPLEX, fontScale = 1, color = (0,0,0), thickness = 2)
                day, time = get_day_time()   
